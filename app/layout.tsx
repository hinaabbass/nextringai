...
export const metadata: Metadata = {
  ...
  description:
    "Stop losing roofing jobs from missed calls. NextRing AI answers 24/7, books appointments, follows up leads, and helps  roofers close more jobs automatically.",
  keywords: [
    "AI receptionist",
    "roofing leads",
